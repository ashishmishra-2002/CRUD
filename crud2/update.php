...
if(isset($_POST['update'])) {
    ...
    $sql = "UPDATE register 
    SET first_name = '$first_name', last_name = '$last_name', email = '$email', phone = '$phone', password = '$password' WHERE id = $id";
...
<html lang="en">
  ...
  <body>
    ...
    if ($success) {
        ...
        echo "<p class=' text-bg-success'><strong>Success: </strong>Updated successfully!</p>";
    //   </div>";
        //echo "Updated successfully";
    }elseif( $error) {
        echo "<p class=' text-bg-danger'><strong>Error: </strong> Can't Update!</p>";
    }
    ?>
